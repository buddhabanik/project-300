...
<body>
    ...
    <div class="container">
     ...
     <form class="well form-horizontal action=" action="/student"  method="POST">
   ...
   <div class="form-group"> 
    ...
    <div class="form-group">
	  ...
	  <div class="input-group">
	  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	  <input  name="roll" placeholder="First Name" class="form-control"  type="text" required>
	    </div>
	  </div>
	</div>
		...
		<div class="form-group">
		  ...
		  <div class="input-group">
		  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		  <input  name="address" placeholder="First Name" class="form-control"  type="text">
		    </div>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="input-group">
		  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		  <input type="file" name="image" accept-charset="UTF-8" enctype="multipart/form-data" >
